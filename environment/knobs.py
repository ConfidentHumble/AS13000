...
KNOB_DETAILS = ['client_oc_size': ['OPT_U64', [4096.0, 4294967296.0, 2147483648.0]],
    ...
    'mds_early_reply': ['OPT_BOOL', [flase, true, 0]],
    'mds_enable_op_tracker': ['OPT_BOOL', [flase, true, 1]],
    'mds_memory_optimize': ['OPT_BOOL', [flase, true, 1]],
    'mds_store_backtrace_num': ['OPT_U32', [1.0, 10240.0, 500.0]],
    'mds_store_mpool_multi': ['OPT_BOOL', [flase, true, 1]],
    'bluefs_alloc_size': ['OPT_U64', [4096.0, 4194304.0, 1048576.0]],
    'bluefs_buffered_io': ['OPT_BOOL', [flase, true, 0]],
    'bluefs_max_prefetch': ['OPT_U64', [4096.0, 4194304.0, 1048576.0]],
    'bluefs_min_flush_size': ['OPT_U64', [2048.0, 2097152.0, 524288.0]],
    'bluefs_preextend_wal_files': ['OPT_BOOL', [flase, true, 0]],
    'bluefs_sync_write': ['OPT_BOOL', [flase, true, 0]],
    'client_acl_choose_optimization': ['OPT_BOOL', [flase, true, 1]],
    'client_acl_delete_permissions': ['OPT_BOOL', [flase, true, 0]],
    'client_acl_extend_permissions': ['OPT_BOOL', [flase, true, 0]],
    'client_acl_type': ['OPT_STR', [none, posix_acl, posix_acl]],
    'client_acl_update': ['OPT_BOOL', [flase, true, 0]],
    'client_acl_visible_permissions': ['OPT_BOOL', [flase, true, 0]],
    'client_agg_delete_ctime': ['OPT_U32', [60.0, 3600.0, 600.0]],
    'client_agg_filetier': ['OPT_BOOL', [flase, true, 0]],
    'client_agg_max_file_size': ['OPT_U64', [512.0, 4194304.0, 524288.0]],
    'client_agg_scan_interval': ['OPT_DOUBLE', [60.0, 7200.0, 3600.0]],
    'client_aggfile_delete': ['OPT_INT', [flase, true, 0]],
    'client_aggobj_flush_interval': ['OPT_U32', [1.0, 60.0, 5.0]],
    'client_aggregate_file_size': ['OPT_U64', [524288.0, 4294967296.0, 536870912.0]],
    'client_auto_drop_cap': ['OPT_BOOL', [flase, true, 1]],
    ...
    'client_cap_fs_restrain': ['OPT_BOOL', [flase, true, 0]],
    'client_cap_monitoring': ['OPT_BOOL', [flase, true, 0]],
    'client_cap_revoke_awake': ['OPT_BOOL', [flase, true, 1]],
    'client_cap_revoke_reset': ['OPT_BOOL', [flase, true, 1]],
    'client_cap_revoking_print': ['OPT_BOOL', [flase, true, 0]],
    'client_caps_nohit': ['OPT_U32', [1.0, 1024.0, 200.0]],
    'client_change_inst_sync': ['OPT_BOOL', [flase, true, 1]],
    'client_check_InodeValid': ['OPT_BOOL', [flase, true, 1]],
    'client_check_pool_perm': ['OPT_BOOL', [flase, true, 1]],
    'client_clear_dir_complete': ['OPT_BOOL', [flase, true, 1]],
    'client_control_time_busy': ['OPT_INT', [1.0, 60.0, 5.0]],
    'client_control_time_tbusy': ['OPT_INT', [1.0, 120.0, 20.0]],
    'client_ctime_opts': ['OPT_BOOL', [flase, true, 0]],
    'client_data_consistent': ['OPT_BOOL', [flase, true, 1]],
    'client_oc': ['OPT_BOOL', [flase, true, 1]],
    ...
    'client_write_opts_switch': ['OPT_BOOL', [flase, true, 0]],
    'fuse_atomic_o_trunc': ['OPT_BOOL', [flase, true, 1]],
    'fuse_big_writes': ['OPT_BOOL', [flase, true, 1]],
    'fuse_disable_pagecache': ['OPT_BOOL', [flase, true, 0]],
    'fuse_multithreaded': ['OPT_BOOL', [flase, true, 1]],
    'fuse_require_active_mds': ['OPT_BOOL', [flase, true, 1]],
    'fuse_syncfs_on_mksnap': ['OPT_BOOL', [flase, true, 1]],
    'fuse_use_invalidate_cb': ['OPT_BOOL', [flase, true, 1]],
    'fuse_use_memory_opts': ['OPT_BOOL', [flase, true, 1]],
    'journaler_allow_split_entries': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_async_inode_map': ['OPT_BOOL', [flase, true, 0]],
    'mds_bal_frag': ['OPT_BOOL', [flase, true, 0]],
    'mds_bal_fragment_control': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_beacon_epoch_skip_dne': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_cap_fs_restrain': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_detail_track': ['OPT_BOOL', [flase, true, 0]],
    'mds_dir_max_commit_size': ['OPT_INT', [1.0, 100.0, 10.0]],
    'mds_early_reply': ['OPT_BOOL', [flase, true, 0]],
    'mds_enable_op_tracker': ['OPT_BOOL', [flase, true, 1]],
    'mds_enforce_unique_name': ['OPT_BOOL', [flase, true, 1]],
    'mds_file_delete_actual_size': ['OPT_BOOL', [flase, true, 0]],
    'mds_filetier_cache_size': ['OPT_INT', [1000.0, 800000.0, 100000.0]],
    'mds_filetier_preopen': ['OPT_BOOL', [flase, true, 0]],
    'mds_filetier_reply_file_check': ['OPT_BOOL', [flase, true, 0]],
    'mds_fragment_dir_size_migrator': ['OPT_INT', [10.0, 3000.0, 300.0]],
    'mds_fragment_failinto_queue': ['OPT_BOOL', [flase, true, 0]],
    'mds_fragment_file_migrator_control': ['OPT_BOOL', [flase, true, 0]],
    'mds_fragment_file_size_migrator': ['OPT_INT', [500.0, 50000.0, 5000.0]],
    'mds_fragment_migrator_control': ['OPT_BOOL', [flase, true, 0]],
    'mds_fragment_size_migrator': ['OPT_INT', [1.0, 100.0, 3.0]],
    'mds_fragment_skip_master_rank': ['OPT_BOOL', [flase, true, 0]],
    'mds_fs_filetier': ['OPT_U32', [0.0, 100.0, 0.0]],
    'mds_import_caps_for_open': ['OPT_BOOL', [flase, true, 0]],
    ...
    'mds_md_readahead': ['OPT_BOOL', [flase, true, 0]],
    'mds_memory_captrim': ['OPT_BOOL', [flase, true, 0]],
    'mds_memory_optimize': ['OPT_BOOL', [flase, true, 1]],
    'mds_metablob_not_check_inline': ['OPT_BOOL', [flase, true, 0]],
    'mds_multimds_snapshot_upgrade': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_purge_delay_req': ['OPT_BOOL', [flase, true, 0]],
    'mds_quota_early_reply': ['OPT_BOOL', [flase, true, 0]],
    'mds_readdir_way_inodex': ['OPT_BOOL', [flase, true, 0]],
    'mds_reconnect_probe_old_client': ['OPT_BOOL', [flase, true, 1]],
    ...
    'mds_recover_not_check_time': ['OPT_BOOL', [flase, true, 0]],
    ...
    'mds_session_auto_evict': ['OPT_BOOL', [flase, true, 0]],
    'mds_session_autoclose': ['OPT_FLOAT', [30.0, 900.0, 300.0]],
    'mds_session_open_reack': ['OPT_BOOL', [flase, true, 1]],
    'mds_session_stale_not_recover': ['OPT_BOOL', [flase, true, 0]],
    ...
    'mds_snap_rstat': ['OPT_BOOL', [flase, true, 0]],
    'mds_standby_for_fscid': ['OPT_INT', [-10.0, 10.0, -1.0]],
    'mds_standby_for_name': ['OPT_STR', [, , ]],
    'mds_standby_for_rank': ['OPT_INT', [-10.0, 10.0, -1.0]],
    'mds_standby_replay': ['OPT_BOOL', [flase, true, 0]],
    'mds_stop_subtree': ['OPT_U32', [1.0, 500.0, 50.0]],
    'mds_store_backtrace_not_check_old': ['OPT_BOOL', [flase, true, 1]],
    'mds_store_backtrace_num': ['OPT_U32', [50.0, 5000.0, 500.0]],
    'mds_store_mpool_multi': ['OPT_BOOL', [flase, true, 1]],
    'mds_store_mpool_new': ['OPT_BOOL', [flase, true, 1]],
    'mds_switch_fast_try': ['OPT_BOOL', [flase, true, 1]],
    'mds_switch_fast_try_multi': ['OPT_BOOL', [flase, true, 1]],
    'mds_tick_interval': ['OPT_FLOAT', [1.0, 60.0, 5.0]],
    'mds_trim_bot_interval': ['OPT_INT', [1.0, 100.0, 10.0]],
    'mds_trim_tid': ['OPT_BOOL', [flase, true, 1]],
    'mds_truncate_mode': ['OPT_INT', [0.0, 100.0, 0.0]],
    'mds_weak_consistency': ['OPT_BOOL', [flase, true, 0]],
    'multi_mds_balance': ['OPT_BOOL', [flase, true, 1]],
